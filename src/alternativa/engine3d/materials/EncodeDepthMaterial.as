...
//					checkDiffAngle(bmd.getPixel(i, 0), 2*(i/255 - 0.5));
			...
			var inverseY:int =(camera.isLeftHanded) ? -1 : 1;
			if (program.cTransformRow2 >= 0) drawUnit.setFragmentConstantsFromNumbers(program.cTransformRow2, inverseY*object.localToCameraTransform.e, inverseY*object.localToCameraTransform.f, inverseY*object.localToCameraTransform.g, 1);
